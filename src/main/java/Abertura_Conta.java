...
public class Abertura_Conta {
	...
	private void initialize() {
		...
		comboTpmovimento.addItem(new Tpmovimento("5", "Altera�ao"));
		comboTpmovimento.addItem(new Tpmovimento("7", "Liquida�ao"));
		...
		btnIncColaborador.addActionListener(new ActionListener() {
			...
			{
				JOptionPane.showMessageDialog(btnIncColaborador, "Algo deu errado, confira as posi��es por favor!!!");
            ex.printStackTrace();
			}
